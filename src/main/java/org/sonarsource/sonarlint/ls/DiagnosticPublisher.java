...
public class DiagnosticPublisher {
  ...
  public void publishScaIssues(URI f) {
    client.publishScaIssues(createPublishScaIssuesParams(f));
  }
  ...
  private PublishDiagnosticsParams createPublishScaIssuesParams(URI folderUri) {
    var p = new PublishDiagnosticsParams();
