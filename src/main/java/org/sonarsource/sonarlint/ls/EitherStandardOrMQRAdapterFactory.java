...
import org.sonarsource.sonarlint.core.rpc.protocol.adapter.CustomEitherAdapterFactory;
...
public class EitherStandardOrMQRAdapterFactory extends CustomEitherAdapterFactory<StandardModeDetails, MQRModeDetails> {
  private static final TypeToken<Either<StandardModeDetails, MQRModeDetails>> ELEMENT_TYPE = new TypeToken<>() {
  };

  public EitherStandardOrMQRAdapterFactory() {
