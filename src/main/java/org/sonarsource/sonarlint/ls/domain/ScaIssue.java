...
public class ScaIssue extends ScaIssueDto {
  String workspaceFolderUri;
  String source;

  public ScaIssue(ScaIssueDto scaIssueDto, String workspaceFolderUri) {
    super(scaIssueDto.getId(), scaIssueDto.getType(), scaIssueDto.getSeverity(), scaIssueDto.getStatus(),
      scaIssueDto.getPackageName(), scaIssueDto.getPackageVersion(), scaIssueDto.getTransitions());
