...
//    var issue = mockIssue();
//    var issues = List.of(((DelegatingIssue) issue));
...
//  }
//
//  private Collection<Issue> matchAndTrack(ServerIssueTrackerWrapper tracker, String filePath, Collection<DelegatingIssue> issues) {
...
//    tracker.matchAndTrack(filePath, issues, recorded::add, shouldFetchServerIssues, openFile);
//    return recorded;
//  }
//
...
//    return new ServerIssueTrackerWrapper(engine, projectKey, branchSupplier, backendServiceFacade, workspaceFoldersManager, logTester.getLogger());
//  }

  // create uniquely identifiable issue
  private DelegatingIssue mockIssue() {
